...
export default function Test() {
  ...
  const toggleSwitchTheme = () => setIsDarkMode(previousState => !previousState);

  return (
    <View style={{ backgroundColor: '#FBFBFB', flex: 1, alignContent: 'center', }}>
      <View style={{ gap: 10, marginLeft: 29, marginTop: 43 }}>
        ...
        <View style={{ alignSelf: 'center', justifyContent: 'center', marginTop: 10, marginBottom: 20 }}>
          <CustomPFP
            first={firstN}
            last={lastN}
            width={128}
          ...
          />
          <Text style={{ fontSize: 24, color: COLORS.blackText, fontStyle: FONTS.bold, alignSelf: 'center', marginTop: 8 }}>
            {name}
          </Text>
        </View>
